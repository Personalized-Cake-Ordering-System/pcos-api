...
namespace CusCake.Infrastructures.Migrations
{
    ...
    [Migration("20250428082532_update_bakery")]
    partial class update_bakery
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CusCake.Domain.Entities.AvailableCake", b =>
                {
                    ...
                    b.Property<int>("QuantityDefault")
                        .HasColumnType("int")
                        .HasColumnName("quantity_default")
                        .HasAnnotation("Relational:JsonPropertyName", "quantity_default");
            ...
            modelBuilder.Entity("CusCake.Domain.Entities.Bakery", b =>
                {
                    ...
                    b.Property<Guid?>("BusinessLicenseFileId")
                        .HasColumnType("char(36)")
                        .HasColumnName("business_license_file_id")
                        .HasAnnotation("Relational:JsonPropertyName", "business_license_file_id");
                    ...
                    b.Property<TimeSpan?>("CloseTime")
                        ...
                        .HasAnnotation("Relational:JsonPropertyName", "close_time");
                    ...
                    b.Property<Guid?>("FoodSafetyCertificateFileId")
                        .HasColumnType("char(36)")
                        .HasColumnName("food_safety_certificate_file_id")
                        .HasAnnotation("Relational:JsonPropertyName", "food_safety_certificate_file_id");
                    ...
                    b.Property<TimeSpan?>("OpenTime")
                        ...
                        .HasAnnotation("Relational:JsonPropertyName", "open_time");
                    ...
                    b.HasIndex("FoodSafetyCertificateFileId");
            ...
            modelBuilder.Entity("CusCake.Domain.Entities.Order", b =>
                {
                    ...
                    b.Property<DateTime?>("CanceledAt")
                        ...
                        .HasAnnotation("Relational:JsonPropertyName", "canceled_at");
                    ...
                    b.Property<DateTime?>("PickedUpAt")
                        ...
                        .HasAnnotation("Relational:JsonPropertyName", "picked_up_at");
                    ...
                    b.Property<DateTime?>("ShippingCompletedAt")
                        .HasColumnType("datetime(6)")
                        .HasColumnName("shipping_completed_at")
                        .HasAnnotation("Relational:JsonPropertyName", "shipping_completed_at");
            ...
            modelBuilder.Entity("CusCake.Domain.Entities.Report", b =>
                {
                    ...
                    b.Property<string>("RejectReason")
                        ...
                        .HasAnnotation("Relational:JsonPropertyName", "reject_reason");
            ...
            modelBuilder.Entity("CusCake.Domain.Entities.Wallet", b =>
                {
                    ...
                    b.HasAnnotation("Relational:JsonPropertyName", "wallet");
                });
            ...
            modelBuilder.Entity("CusCake.Domain.Entities.WalletTransaction", b =>
                {
                    ...
                    b.Property<string>("OrderTargetCode")
                        .HasColumnType("longtext")
                        .HasColumnName("order_target_code")
                        .HasAnnotation("Relational:JsonPropertyName", "order_target_code");

                    b.Property<Guid?>("OrderTargetId")
                        .HasColumnType("char(36)")
                        .HasColumnName("order_target_id")
                        .HasAnnotation("Relational:JsonPropertyName", "order_target_id");

                    b.Property<Guid?>("TargetUserId")
                        .HasColumnType("char(36)")
                        .HasColumnName("target_user_id")
                        .HasAnnotation("Relational:JsonPropertyName", "target_user_id");

                    b.Property<string>("TargetUserType")
                        .HasColumnType("longtext")
                        .HasColumnName("target_user_type")
                        .HasAnnotation("Relational:JsonPropertyName", "target_user_type");
            ...
            modelBuilder.Entity("CusCake.Domain.Entities.Bakery", b =>
                {
                    ...
                    b.HasOne("CusCake.Domain.Entities.Storage", "BusinessLicenseFile")
                        .WithMany()
                        .HasForeignKey("BusinessLicenseFileId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("CusCake.Domain.Entities.Storage", "FoodSafetyCertificateFile")
                        .WithMany()
                        .HasForeignKey("FoodSafetyCertificateFileId")
                        .OnDelete(DeleteBehavior.Cascade);
                    ...
                    b.Navigation("FoodSafetyCertificateFile");
