...
namespace CusCake.Infrastructures.Repositories
{
    ...
    // {
    // }
    public class CakeMessageOptionRepository(AppDbContext context, ICurrentTime currentTime, IClaimsService claimsService) : GenericRepository<CakeMessageOption>(context, currentTime, claimsService), ICakeMessageOptionRepository
    {
    }
}
